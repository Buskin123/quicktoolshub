...
import { Calculator, ArrowRight, Home, ChevronRight } from "lucide-react";
import { Layout } from "@/components/layout/Layout";
import { ToolCard } from "@/components/tools/ToolCard";
import { tools } from "@/data/tools";

export default function Calculators() {
  const categoryTools = tools.filter(t => ['age-calculator', 'emi-calculator', 'percentage-calculator', 'gst-calculator'].includes(t.id));

  return (
    <Layout>
      <Helmet>
        <title>Free Calculators — EMI, GST & More | QuickToolsHub</title>
        <meta name="description" content="Instant calculators for everyday financial and personal needs. Get accurate results for EMI, GST, percentage, and age calculations in seconds." />
      </Helmet>

      <div className="bg-gradient-to-br from-green-600 to-green-800 py-16 px-4 text-white">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Calculators</h1>
          <p className="text-green-100 text-lg max-w-2xl mx-auto leading-relaxed">
            Instant calculators for everyday financial and personal needs. Get accurate results for EMI, GST, percentage, and age calculations in seconds.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <nav className="flex items-center gap-1 text-sm text-gray-500 dark:text-gray-400 mb-8" aria-label="Breadcrumb">
          ...
          <span className="text-gray-800 dark:text-gray-200 font-medium">Calculators</span>
        </nav>
