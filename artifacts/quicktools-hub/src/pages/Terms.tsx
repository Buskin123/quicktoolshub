      ...
      <div className="max-w-3xl mx-auto px-4 py-14">
        ...
        <div className="space-y-6 text-gray-600 text-sm leading-relaxed">
          {[
            ...
            ["6. Advertising", "Our site displays third-party advertisements via Google AdSense and Monetag. We are not responsible for the content of these advertisements."],
            ...
            ["8. Governing Law", "These Terms are governed by applicable law. Any disputes shall be resolved in the appropriate jurisdiction."],
            ["9. Contact", "For questions about these Terms, contact us at hello@quicktoolshub.com"],
          ].map(([title, content]) => (
