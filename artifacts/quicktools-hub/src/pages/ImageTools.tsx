...
import { Image, ArrowRight, Home, ChevronRight } from "lucide-react";
import { Layout } from "@/components/layout/Layout";
import { ToolCard } from "@/components/tools/ToolCard";
import { tools } from "@/data/tools";

export default function ImageTools() {
  const categoryTools = tools.filter(t => ['image-compressor', 'jpg-to-png', 'png-to-jpg', 'background-remover'].includes(t.id));

  return (
    <Layout>
      <Helmet>
        <title>Free Image Tools — Compress & Convert | QuickToolsHub</title>
        <meta name="description" content="Professional image tools for compression and format conversion. All processing happens locally — your photos never leave your device." />
      </Helmet>

      <div className="bg-gradient-to-br from-blue-600 to-blue-800 py-16 px-4 text-white">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Image Tools</h1>
          <p className="text-blue-100 text-lg max-w-2xl mx-auto leading-relaxed">
            Professional image tools for compression and format conversion. All processing happens locally — your photos never leave your device.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <nav className="flex items-center gap-1 text-sm text-gray-500 dark:text-gray-400 mb-8" aria-label="Breadcrumb">
          ...
          <span className="text-gray-800 dark:text-gray-200 font-medium">Image Tools</span>
        </nav>
